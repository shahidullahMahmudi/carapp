...
const CardDetails = ({isOpen,closeModal,car}:CarDetailsProps) => {
    ...
    <Transition appear show={isOpen} as={Fragment}>
        <Dialog as='div' className='relative z-10' onClose={closeModal}>
            ...
            >
        <Dialog.Panel className='relative w-full max-w-lg max-h-[90vh] overflow-auto transform rounded-2xl text-left shadow-xsl transition-all flex flex-col gap-5 bg-white p-2'>
